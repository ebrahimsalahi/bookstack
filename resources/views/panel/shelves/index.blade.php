                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb float-sm-right mt-2 mb-2">
                            ...
                            <li class="breadcrumb-item active">مشاهده قفسه ها</li>
                        </ol>
                    </div><!-- /.col -->
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header mb-3">
                                <h3 class="card-title">جدول قفسه ها</h3>
                                <div class="card-tools">

                                    @can('check','users_add')
                                        <a href="{{route('newShelf')}}" class="btn btn-primary btn-sm float-left">
                            ...
                            <div class="card-body table-responsive ">
                                <table class="table table-hover mb-5" id="tb_shelves">
                                    <thead>
