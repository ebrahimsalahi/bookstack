                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header mb-3">
                                <h3 class="card-title">  مشخصات نقش </h3>
                            ...
                            <div class="card-body table-responsive ">
                                <form action="{{route('saveRole')}}" method="post" class="form_ajaxi">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="description" cols="30" rows="1"></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-3 m-1">
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input type="checkbox" class="icheckbox  form-check-input pr-5" value="{{$permission->id}}" name="permissions[]">
                                    ...
                                    <button type="submit" class="btn btn-primary">  ثبت نقش جدید</button>
                                </form>
